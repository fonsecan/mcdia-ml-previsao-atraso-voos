...
Também são excluídos da base de modelagem os registros com `atraso_chegada_min < -1440`, pois representam uma chegada registrada mais de 24 horas antes do horário previsto e são tratados como inconsistências de data/hora. Esses registros permanecem no dataset derivado para auditoria.
